            ...
            <div className="row mt-3">
                <div className="col-md mr-3">
                    ...
                    <form action="https://formspree.io/mbjlqyrw" method="POST">
                        ...
                        <button type="submit" className="btn btn-light cFormBtn">Send</button>
                    </form>
                </div>
                <div className="col-md contactLinks ml-3">
                    <div className="contactBtn">
                        <a href="mailto:taylormareebruno@gmail.com" className="contactLink">
                            <i className="fas fa-envelope fa-2x contactIcon"></i><br />
                            <span className="cLink">Email</span>
                        </a>
                    </div>
                    <div className="contactBtn">
                        <a href="tel:828-449-9781" className="contactLink">
                            <i className="fas fa-phone-square fa-2x contactIcon"></i><br />
                            <span className="cLink">Phone</span>
                        </a>
                    </div>
                    <div className="contactBtn">
                        <a href="/assets/images/resumePDF.pdf"  target="_blank" rel="noopener noreferrer" className="contactLink">
                            <i className="fas fa-file fa-2x contactIcon"></i><br />
                            <span className="cLink">Resume</span>
                        </a>
                    </div>  
                    <div className="contactBtn">
                        <a href="https://github.com/taylormbruno"  target="_blank" rel="noopener noreferrer" className="contactLink">
                            <i className="fab fa-github fa-2x contactIcon"></i><br />
                            <span className="cLink">Github</span>
                        </a>
                    </div>
                    <div className="contactBtn">
                        <a href="https://www.linkedin.com/in/taylor-bruno-5b5a49189/"  target="_blank" rel="noopener noreferrer" className="contactLink">
